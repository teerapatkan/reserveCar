...
def user_input_features():
    ...
    # fuel = st.selectbox('ประเภทเชื้อเพลิง', ('0', '1','2','3','4'))
...
df['area'] = df['area'].replace(['กรุงเทพฯและปริมณฑล', 'ต่างจังหวัด'], ['0', '1'])
df['fuel'] = df['fuel'].replace(['NGV', 'NGV, แก๊สโซฮอล 95','แก๊สโซฮอล 95','แก๊สโซฮอล 95, เบนซิน','ดีเซล'], ['0', '1','2','3','4'])
